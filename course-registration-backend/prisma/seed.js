...
async function createSection(courseCode, sectionNumber, patternIndex, lecturerIndex, capacity, semester = ACTIVE_SEMESTER) {
...
async function findSection(courseCode, sectionNumber = '01', semester = ACTIVE_SEMESTER) {
